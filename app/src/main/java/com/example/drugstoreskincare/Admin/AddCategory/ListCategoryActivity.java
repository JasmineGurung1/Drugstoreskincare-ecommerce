package com.example.drugstoreskincare.Admin.AddCategory;
...
public class ListCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullCatRV = findViewById(R.id.fullCategoryRV);
        getOnline();
...
//                swipeRefresh.setRefreshing(false);
    ...
    private void showCategoryView(List<Category> categories) {fullCatRV.setHasFixedSize(true);
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                if (swipeDir > 0) {
                    String key = SharedPrefUtils.getSting(ListCategoryActivity.this, getString(R.string.api_key));
